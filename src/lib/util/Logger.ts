import { ILogRoutineFunc, ILogger, ELogLevel, ISourceLocation, ILoggerEntity } from "../idl/ILogger"
import { IMap } from "../idl/IMap"
import { isNull, isInt, isDef, isObject } from "../common"
...
export class Logger implements ILogger {
	...
	registerCode(eCode: number, sMessage: string = this._sUnknownMessage): boolean {
	...
	registerCodeFamily(eCodeMin: number, eCodeMax: number, sFamilyName: string = this.generateFamilyName()): boolean {
	...
	setCodeFamilyRoutine(): boolean {
		...
		var fnLogRoutine: ILogRoutineFunc | null = null;
		...
		var pCodeFamilyRoutineMap: IMap<ILogRoutineFunc | null> = this._pCodeFamilyRoutineDMap[sFamilyName];
