...
import { IAFXExprInstruction, IAFXInstruction, EAFXInstructionTypes, IAFXInitExprInstruction, IAFXVariableDeclInstruction, IAFXVariableTypeInstruction, IAFXIdInstruction, EAFXBlendMode } from "../../idl/IAFXInstruction";
