export enum EAnalyzerErrors {
    ...
    InvalidFunctionRedefinition = 2227,
    ...
    InvalidFuncDefenitionReternType = 2247,
    InvalidSystemFunctionRedefinition = 2248,
    InvalidSystemFunctionReternType = 2249,
    InvalidTypeNameNotType = 2250,
    InvalidTypeVectorMatrix = 2251,
    InvalidTechniqueNameRedefinition = 2252,
    ...
    InvalidFunctionVertexRedefinition = 2259,
    InvalidFunctionPixelRedefinition = 2260,
